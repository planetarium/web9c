...
function Layout({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col min-h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container place-self-center rounded-2xl shadow-2xl my-auto p-6", children }) });
}
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold animate-scrollText p-4", children: "Hi There! 안녕하세요! おはよう!" }) });
}
const styles = "";
